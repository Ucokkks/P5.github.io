...
<body>
    <div class="grid grid-cols-3 gap-8 mt-8 p-8">
        ...
        if ($result_enum->num_rows > 0) {
            ...
            if (in_array('apartement', $enum_values)) {
                // Query untuk mengambil data villa dengan jenis 'villa'
                $sql_properties = "SELECT nama_rumah, price, location, kamar_tidur, kamar_mandi, gambar FROM rumah WHERE type = 'apartement' ORDER BY RAND() LIMIT 3";
